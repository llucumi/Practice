...
func main() {
	...
	// 	fmt.Println(err)
	// }
	// readValue, err := service.Bookings.Read(service.NewBookings(dataRead), 26)
	// if err != nil {
	// 	fmt.Println(err)
	// }
	...
	// dataWriteUpdate := ""
	// for _, values := range dataUpdate {
	// 	//Creando tickets
	// 	fmt.Println(values)
	// 	// stringformat = append(stringformat, values)
	// 	dataWriteUpdate += string(fmt.Sprint(values.Id, ",", values.Names, ",", values.Email, ",", values.Destination, ",", values.Date, ",", values.Price, "\n"))
	// 	if err != nil {
	// 		fmt.Println(err)
	// 	}
	// }
